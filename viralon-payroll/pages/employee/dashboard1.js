...
//         router.push("/employee/login");
//       } else {
//         if (!data.employee.hasCompletedProfile) {
//           router.push("/employee/complete-profile"); // ✅ force profile completion
//           return;
//         }
//         setEmployee(data.employee);
//         fetchTodayAttendance();
...
//       <div className="main-nav dash-nav desktop-none">
//         <nav className="navbar">
//           <div className="col-12">
//             <div className="navbar-header">
//               <Link className="navbar-brand" href="/">
//                 <img src="/assets/images/logo.png" width="80" alt="Viralon" />
//               </Link>
//             </div>
...
//             >
//               <i className="zmdi zmdi-menu" style={{ fontSize: "17px" }}></i>
//             </button>
//           </div>
//         </nav>
//       </div>
...
//         {/* Sidebar */}
//         <div
//           className="mobile-none bg-dark-light text-white p-3"
//           style={{ width: 260 }}
//         >
...
//                   return (
//                     <button className="check-in-btn" onClick={handleLogin}>
...
//                 href="#"
//               >
//                 <i className="zmdi zmdi-calendar-note"></i> Attendance Summary
//               </a>
//             </li>
...
//                 href="#"
//               >
//                 <i className="zmdi zmdi-calendar-check"></i> Leave Management
//               </a>
//             </li>
...
//                 href="#"
//               >
//                 <i className="zmdi zmdi-receipt"></i> Salary Slips
//               </a>
//             </li>
//             <li className="nav-item">
//               <a
...
//                 href="#"
//               >
//                 <i className="zmdi zmdi-file-text"></i> Documents
//               </a>
//             </li>
//           </ul>
//         </div>

//         {/* Mobile Sidebar with Bootstrap 5 Offcanvas */}
//         <nav className="d-md-none text-white">
//           {/* Offcanvas Sidebar */}
//           <div
//             className="offcanvas offcanvas-start bg-dark-light text-white"
//             tabIndex="-1"
//             id="mobileSidebar"
...
//                       return (
//                         <button
//                           className="check-in-btn btn btn-primary btn-sm"
//                           onClick={handleLogin}
//                         >
//                           {punches.length === 0 ? "Check-in" : "Check-in Again"}
//                         </button>
...
//                       return (
//                         <div
//                           className="check-out-button btn btn-danger btn-sm"
//                           onClick={() => handleLogout(false)}
...
//                     href="#"
//                   >
//                     <i className="zmdi zmdi-calendar-note"></i> Leave &
//                     Attendance
//                   </a>
//                 </li>
...
//                     href="#"
//                   >
//                     <i className="zmdi zmdi-calendar-check"></i> Leave Summary
//                   </a>
//                 </li>
...
//               <div className="row">
//                 <div className="col-md-4 mt-3 margin-t-mob">
...
//                 <div className="col-md-8 mt-3 margin-t-mob">
...
//                                 }
//                                 .custom-badge.info {
//                                   background-color: #17a2b83d; /* soft teal */
//                                   color: rgb(23, 162, 184); /* teal text */
//                                 }
//                               `}</style>
//                             </td>
...
//                                   background-color: #5a57fb3d;
//                                   color: rgb(90, 87, 251);
//                                 }
//                                 .custom-badge.rejected {
//                                   background-color: #ff4d4d3d;
//                                   color: rgb(255, 77, 77);
//                                 }
//                                 .custom-badge.pending {
//                                   background-color: #fbc02d3d;
